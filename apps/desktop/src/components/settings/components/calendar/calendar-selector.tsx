        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="rounded-full p-1 hover:bg-surface-400 transition-colors"
            >
              <RefreshCwIcon
                size={12}
                className={cn(
          ...
          : (
            Object.entries(calendarsQuery.data?.grouped ?? {}).sort(([sourceA], [sourceB]) => {
              ...
              <div key={source} className="mb-5">
                <div className="text-sm font-semibold text-foreground/90 mb-2">{source}</div>
                <div className="pl-2 space-y-2.5">
                  {sourceCalendars
                    ...
                    .map((calendar) => (
                      <div
                        key={calendar.id}
                        className="flex items-center space-x-3 py-1 px-2 rounded-md hover:bg-surface-400/50 transition-colors"
                      >
                        <Checkbox
                        ...
                        <label
                          ...
                          className="text-sm font-medium cursor-pointer text-foreground/80 flex-1"
                        >
                          {calendar.name}
                        </label>
                      </div>
