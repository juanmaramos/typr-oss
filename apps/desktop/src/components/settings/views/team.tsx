...
import { Modal, ModalBody, ModalDescription, ModalHeader, ModalTitle } from "@typr/ui/components/ui/modal";
  ...
  return (
    <div className="relative h-full">
      <div className="absolute inset-0 backdrop-blur-sm bg-background/50 z-10 flex flex-col items-center justify-center">
        ...
        <p className="text-foreground/80 max-w-md text-center">
          <Trans>
      ...
      <div className="space-y-6">
        ...
        <div className="overflow-clip rounded-lg border bg-card">
          <div className="grid grid-cols-2 gap-4 border-b bg-muted/50 px-6 py-3 text-sm font-bold text-foreground/80">
            <div>
              <Trans>User</Trans>
            </div>
            <div>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 text-muted-foreground hover:text-foreground cursor-pointer hover:bg-foreground hover:text-muted-foreground/50"
                      >
