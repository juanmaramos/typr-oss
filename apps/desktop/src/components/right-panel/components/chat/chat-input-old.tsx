...
export function ChatInput(
  ...
  return (
    <div className="border border-b-0 border-input mx-4 rounded-t-lg overflow-clip flex flex-col bg-background">
      <textarea
        ref={chatInputRef}
        value={inputValue}
        onChange={onChange}
      ...
      <div className="flex items-center justify-between pb-2 px-3">
        {entityId
          ? (
            <Badge
              className="mr-2 bg-background text-foreground border border-border inline-flex items-center gap-1 hover:bg-surface-400 cursor-pointer max-w-48"
