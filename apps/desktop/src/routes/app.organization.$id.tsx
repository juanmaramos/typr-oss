...
import { commands as dbCommands, type Organization } from "@typr/plugin-db";
  ...
  return (
    <div>
      <div className="flex flex-col items-center pb-6">
        <div className="flex items-center justify-center w-24 h-24 mb-3 bg-muted rounded-full">
          <BuildingIcon className="w-12 h-12 text-muted-foreground/70" />
        </div>
