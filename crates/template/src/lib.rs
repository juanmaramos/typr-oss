...
pub enum PredefinedTemplate {
    ...
    AiChatSystem,
    #[strum(serialize = "enhance_youtube.system")]
    EnhanceYoutubeSystem,
    #[strum(serialize = "enhance_youtube.user")]
    EnhanceYoutubeUser,
    #[strum(serialize = "document_edit.system")]
    DocumentEditSystem,
    #[strum(serialize = "document_edit.user")]
    DocumentEditUser,
}
...
impl From<PredefinedTemplate> for Template {
    fn from(value: PredefinedTemplate) -> Self {
        match value {
            ...
            PredefinedTemplate::EnhanceYoutubeSystem => {
                Template::Static(PredefinedTemplate::EnhanceYoutubeSystem)
            }
            PredefinedTemplate::EnhanceYoutubeUser => {
                Template::Static(PredefinedTemplate::EnhanceYoutubeUser)
            }
            PredefinedTemplate::DocumentEditSystem => {
                Template::Static(PredefinedTemplate::DocumentEditSystem)
            }
            PredefinedTemplate::DocumentEditUser => {
                Template::Static(PredefinedTemplate::DocumentEditUser)
            }
        }
    }
}
...
pub const ENHANCE_YOUTUBE_SYSTEM_TPL: &str = include_str!("../assets/enhance_youtube.system.jinja");
pub const ENHANCE_YOUTUBE_USER_TPL: &str = include_str!("../assets/enhance_youtube.user.jinja");
pub const DOCUMENT_EDIT_SYSTEM_TPL: &str = include_str!("../assets/document_edit.system.jinja");
pub const DOCUMENT_EDIT_USER_TPL: &str = include_str!("../assets/document_edit.user.jinja");
...
pub fn init(env: &mut minijinja::Environment) {
    ...
    .unwrap();
    env.add_template(
        PredefinedTemplate::EnhanceYoutubeSystem.as_ref(),
        ENHANCE_YOUTUBE_SYSTEM_TPL,
    )
    .unwrap();
    env.add_template(
        PredefinedTemplate::EnhanceYoutubeUser.as_ref(),
        ENHANCE_YOUTUBE_USER_TPL,
    )
    .unwrap();
    env.add_template(
        PredefinedTemplate::DocumentEditSystem.as_ref(),
        DOCUMENT_EDIT_SYSTEM_TPL,
    )
    .unwrap();
    env.add_template(
        PredefinedTemplate::DocumentEditUser.as_ref(),
        DOCUMENT_EDIT_USER_TPL,
    )
    .unwrap();
