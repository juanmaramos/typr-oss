...
#[cfg(feature = "whisper")]
impl TryInto<typr_whisper::Language> for Language {
    type Error = Error;

    fn try_into(self) -> Result<typr_whisper::Language, Self::Error> {
        use typr_whisper::Language as WL;
...
#[cfg(feature = "whisper")]
impl TryInto<Language> for typr_whisper::Language {
    type Error = Error;
