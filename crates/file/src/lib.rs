...
mod tests {
    ...
    #[tokio::test]
    #[ignore]
    async fn test_download_file_with_callback_huggingface() {
        ...
        let range_response = request_with_range(model_url, Some(initial_size))
            .await
            .unwrap();
        assert_eq!(
            range_response.status().as_u16(),
        ...
        let result = download_file_with_callback(model_url, temp_path, |progress| {
