...
impl AEC {
    pub fn new() -> Result<Self, crate::Error> {
        ...
        let session_1 = typr_onnx::load_model(model::BYTES_1)?;
        let session_2 = typr_onnx::load_model(model::BYTES_2)?;
    ...
    fn run_model_1(
        ...
        in_mag: &Array3<f32>,
        lpb_mag: &Array3<f32>,
    ) -> Result<typr_onnx::ndarray::Array1<f32>, crate::Error> {
        let mut outputs = self.session_1.run(typr_onnx::ort::inputs![
    ...
    fn run_model_2(
        ...
        let mut outputs = self.session_2.run(typr_onnx::ort::inputs![
    ...
    fn _process_internal(
        ...
        for idx in 0..num_blocks {
            ...
            let out_slice = out_block_1d.as_slice().ok_or_else(|| {
                Error::ShapeError(typr_onnx::ndarray::ShapeError::from_kind(
                    typr_onnx::ndarray::ErrorKind::IncompatibleLayout,
                ))
            })?;
...
mod tests {
    ...
    mod data {
        ...
        pub const TYPR_LPB: &[u8] = include_bytes!("../data/typr_lpb.wav");
        pub const TYPR_MIC: &[u8] = include_bytes!("../data/typr_mic.wav");
