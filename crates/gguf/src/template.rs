...
pub enum ChatTemplate {
    ...
    /// Gemma 4 native format (<|turn>/<turn|>) — prompt built in Rust, bypasses minijinja
    Gemma4Native,
}
...
impl AsRef<str> for ChatTemplate {
    fn as_ref(&self) -> &str {
        match self {
            ...
            // Not used via apply_chat_template; return built-in "gemma" as an inert fallback.
            Self::Gemma4Native => "gemma",
        }
    }
}
