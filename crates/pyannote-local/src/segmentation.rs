...
impl Segmenter {
    pub fn new(sample_rate: u32) -> Result<Self, crate::Error> {
        let session = typr_onnx::load_model(SEGMENTATION_ONNX)?;
...
mod tests {
    ...
    test_segmentation!(test_segmentation_english_1, typr_data::english_1::AUDIO);
    test_segmentation!(test_segmentation_english_2, typr_data::english_2::AUDIO);
}
