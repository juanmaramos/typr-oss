...
- `allow-get-microphone-selection-mode`
- `allow-set-microphone-device`
- `allow-set-microphone-auto`
...
`listener:allow-get-microphone-selection-mode`

</td>
<td>

Enables the get_microphone_selection_mode command without any pre-configured scope.
...
`listener:deny-get-microphone-selection-mode`

</td>
<td>

Denies the get_microphone_selection_mode command without any pre-configured scope.
...
`listener:allow-get-pipeline-status`

</td>
<td>

Enables the get_pipeline_status command without any pre-configured scope.
...
`listener:deny-get-pipeline-status`

</td>
<td>

Denies the get_pipeline_status command without any pre-configured scope.
...
`listener:allow-set-microphone-auto`

</td>
<td>

Enables the set_microphone_auto command without any pre-configured scope.
...
`listener:deny-set-microphone-auto`

</td>
<td>

Denies the set_microphone_auto command without any pre-configured scope.
