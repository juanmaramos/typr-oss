...
- `allow-download-model-background`
- `allow-start-server`
- `allow-stop-server`
...
`local-stt:allow-download-model-background`

</td>
<td>

Enables the download_model_background command without any pre-configured scope.
...
`local-stt:deny-download-model-background`

</td>
<td>

Denies the download_model_background command without any pre-configured scope.
...
`local-stt:allow-get-demo-audio-path`

</td>
<td>

Enables the get_demo_audio_path command without any pre-configured scope.
...
`local-stt:deny-get-demo-audio-path`

</td>
<td>

Denies the get_demo_audio_path command without any pre-configured scope.
