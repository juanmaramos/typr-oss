...
fn make_specta_builder<R: tauri::Runtime>() -> tauri_specta::Builder<R> {
    tauri_specta::Builder::<R>::new()
        ...
        .commands(tauri_specta::collect_commands![
            ...
            commands::get_groq_api_key::<tauri::Wry>,
            commands::set_groq_api_key::<tauri::Wry>,
            ...
            commands::get_assemblyai_api_key::<tauri::Wry>,
            commands::set_assemblyai_api_key::<tauri::Wry>,
            commands::get_stt_model::<tauri::Wry>,
            commands::set_stt_model::<tauri::Wry>,
            commands::set_stt_model_session::<tauri::Wry>,
            commands::clear_stt_model_session::<tauri::Wry>,
            commands::get_cloud_model::<tauri::Wry>,
            commands::set_cloud_model::<tauri::Wry>,
            commands::get_ai_task_defaults::<tauri::Wry>,
            commands::set_ai_task_defaults::<tauri::Wry>,
            commands::process_recorded_cloud::<tauri::Wry>,
        ])
