...
- `allow-get-groq-api-key`
- `allow-set-groq-api-key`
- `allow-get-assemblyai-api-key`
- `allow-set-assemblyai-api-key`
- `allow-get-cloud-model`
- `allow-set-cloud-model`
- `allow-process-recorded-cloud`
- `allow-set-stt-model-session`
- `allow-clear-stt-model-session`
...
`connector:allow-clear-stt-model-session`

</td>
<td>

Enables the clear_stt_model_session command without any pre-configured scope.
...
`connector:deny-clear-stt-model-session`

</td>
<td>

Denies the clear_stt_model_session command without any pre-configured scope.
...
`connector:allow-get-ai-task-defaults`

</td>
<td>

Enables the get_ai_task_defaults command without any pre-configured scope.
...
`connector:deny-get-ai-task-defaults`

</td>
<td>

Denies the get_ai_task_defaults command without any pre-configured scope.
...
`connector:allow-get-assemblyai-api-key`

</td>
<td>

Enables the get_assemblyai_api_key command without any pre-configured scope.
...
`connector:deny-get-assemblyai-api-key`

</td>
<td>

Denies the get_assemblyai_api_key command without any pre-configured scope.
...
`connector:allow-get-cloud-model`

</td>
<td>

Enables the get_cloud_model command without any pre-configured scope.
...
`connector:deny-get-cloud-model`

</td>
<td>

Denies the get_cloud_model command without any pre-configured scope.
...
`connector:allow-get-groq-api-key`

</td>
<td>

Enables the get_groq_api_key command without any pre-configured scope.
...
`connector:deny-get-groq-api-key`

</td>
<td>

Denies the get_groq_api_key command without any pre-configured scope.
...
`connector:allow-get-stt-model`

</td>
<td>

Enables the get_stt_model command without any pre-configured scope.
...
`connector:deny-get-stt-model`

</td>
<td>

Denies the get_stt_model command without any pre-configured scope.
...
`connector:allow-process-recorded-cloud`

</td>
<td>

Enables the process_recorded_cloud command without any pre-configured scope.
...
`connector:deny-process-recorded-cloud`

</td>
<td>

Denies the process_recorded_cloud command without any pre-configured scope.
...
`connector:allow-set-ai-task-defaults`

</td>
<td>

Enables the set_ai_task_defaults command without any pre-configured scope.
...
`connector:deny-set-ai-task-defaults`

</td>
<td>

Denies the set_ai_task_defaults command without any pre-configured scope.
...
`connector:allow-set-assemblyai-api-key`

</td>
<td>

Enables the set_assemblyai_api_key command without any pre-configured scope.
...
`connector:deny-set-assemblyai-api-key`

</td>
<td>

Denies the set_assemblyai_api_key command without any pre-configured scope.
...
`connector:allow-set-cloud-model`

</td>
<td>

Enables the set_cloud_model command without any pre-configured scope.
...
`connector:deny-set-cloud-model`

</td>
<td>

Denies the set_cloud_model command without any pre-configured scope.
...
`connector:allow-set-groq-api-key`

</td>
<td>

Enables the set_groq_api_key command without any pre-configured scope.
...
`connector:deny-set-groq-api-key`

</td>
<td>

Denies the set_groq_api_key command without any pre-configured scope.
...
`connector:allow-set-stt-model`

</td>
<td>

Enables the set_stt_model command without any pre-configured scope.
...
`connector:deny-set-stt-model`

</td>
<td>

Denies the set_stt_model command without any pre-configured scope.
...
`connector:allow-set-stt-model-session`

</td>
<td>

Enables the set_stt_model_session command without any pre-configured scope.
...
`connector:deny-set-stt-model-session`

</td>
<td>

Denies the set_stt_model_session command without any pre-configured scope.
