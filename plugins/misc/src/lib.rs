    ...
    fn test_parse_meeting_link() {
        ...
        let test_cases = vec![
            ...
            TestCase {
                ...
                input: indoc::indoc! {r#"
                    <p>──────────<br/>John is inviting you to a scheduled Zoom meeting.<br/>Join Zoom Meeting<br/>https://example.zoom.us/j/12345678901?pwd=ExamplePasscode.1<br/><br/>
                    View meeting insights with Zoom AI Companion<br/>https://example.zoom.us/launch/edl?muid=00000000-0000-0000-0000-000000000000<br/><br/>
                    Meeting ID: 123 4567 8901<br/>Passcode: 123456</p>
                "#},
                expected:
                    "https://example.zoom.us/j/12345678901?pwd=ExamplePasscode.1",
            },
            ...
            TestCase {
                ...
                input: indoc::indoc! {r#"
                    ...
                    One tap mobile
                    +16694449171,,12345678901#,,,,*123456# US
                    +16699006833,,12345678901#,,,,*123456# US (San Jose)
                    ...
                    Find your local number: https://example.zoom.us/u/example
