...
pub struct ModelManager {
    ...
    model: Arc<Mutex<Option<Arc<typr_llama::Llama>>>>,
...
impl ModelManager {
    ...
    pub async fn get_model(&self) -> Result<std::sync::Arc<typr_llama::Llama>, crate::Error> {
        ...
        match guard.as_ref() {
            ...
            None => {
                ...
                let model = Arc::new(typr_llama::Llama::new(&self.model_path)?);
