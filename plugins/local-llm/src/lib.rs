...
fn make_specta_builder<R: tauri::Runtime>() -> tauri_specta::Builder<R> {
    tauri_specta::Builder::<R>::new()
        ...
        .commands(tauri_specta::collect_commands![
            ...
            commands::download_model_background::<Wry>,
        ...
        .events(tauri_specta::collect_events![events::LlmModelStateEvent])
...
pub fn init<R: tauri::Runtime>() -> tauri::plugin::TauriPlugin<R> {
    ...
    tauri::plugin::Builder::new(PLUGIN_NAME)
        ...
        .setup(|app, _api| {
            ...
            let old_models_dir = data_dir.join("ttt");

            // Create models directory
            let _ = std::fs::create_dir_all(&models_dir);

            // Migration from old "ttt" directory to "models" directory
            if old_models_dir.exists() {
                if let Ok(entries) = std::fs::read_dir(&old_models_dir) {
                    ...
                    let _ = std::fs::remove_dir(&old_models_dir);
                }
            }

            // for backward compatibility - move gguf files from data_dir root
...
mod test {
    ...
    fn shared_request() -> CreateChatCompletionRequest {
        CreateChatCompletionRequest {
            ...
            metadata: Some(
                serde_json::json!({ "grammar": typr_gbnf::Grammar::Enhance { sections: None } }),
            ),
            ..Default::default()
        }
    }
    ...
    fn title_generation_request() -> CreateChatCompletionRequest {
        CreateChatCompletionRequest {
            ...
            metadata: Some(serde_json::json!({ "grammar": typr_gbnf::Grammar::Title })),
            ..Default::default()
        }
    }
