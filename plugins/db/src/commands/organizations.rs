...
pub async fn list_organizations(
    ...
    filter: Option<typr_db_user::ListOrganizationFilter>,
) -> Result<Vec<typr_db_user::Organization>, String> {
...
pub async fn get_organization(
    state: tauri::State<'_, crate::ManagedState>,
    id: String,
) -> Result<Option<typr_db_user::Organization>, String> {
    let guard = state.lock().await;
...
pub async fn upsert_organization(
    state: tauri::State<'_, crate::ManagedState>,
    organization: typr_db_user::Organization,
) -> Result<typr_db_user::Organization, String> {
    let guard = state.lock().await;
